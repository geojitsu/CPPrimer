; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	D:\tools\dev\workspace\cpprimer\CPPrimer\cpprimer\ch7_exAll.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 25   : 	while (cin >> chapter)
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T31016[ebp], eax
	mov	ecx, DWORD PTR $T31016[ebp]
...
; 61   : 	while ((cin >> xval >> yval))
	...
	mov	edx, DWORD PTR $T31035[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR $T31035[ebp]
...
; 156  : 	while ((cin >> total >> choices) && choices <= total)
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T31073[ebp], eax
	mov	edx, DWORD PTR $T31073[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR $T31073[ebp]
	add	ecx, DWORD PTR [eax+4]
	mov	esi, esp
	call	DWORD PTR __imp_??Bios_base@std@@QBEPAXXZ
	cmp	esi, esp
...
$LN3@fill_array:
	...
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
	mov	DWORD PTR $T31089[ebp], eax
	mov	edx, DWORD PTR $T31089[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR $T31089[ebp]
	add	ecx, DWORD PTR [eax+4]
	mov	esi, esp
	call	DWORD PTR __imp_??Bios_base@std@@QBEPAXXZ
	cmp	esi, esp
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T31090[ebp], eax
	mov	eax, DWORD PTR $T31090[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR $T31090[ebp]
...
; 243  : 	Reverse_array(theArray, numberEntered);
...
; 266  : 	int * scores = new int[arraysize];
	...
	add	esp, 4
	mov	DWORD PTR $T31115[ebp], eax
	mov	eax, DWORD PTR $T31115[ebp]
	mov	DWORD PTR _scores$[ebp], eax

; 267  : 	
; 268  : 	cout << "Enter golf scores to be crunched\n#1: ";
...
; 269  : 
; 270  : 	for (int loop = 0; loop < arraysize && cin >> scores[loop]; ++loop)

	mov	DWORD PTR _loop$23798[ebp], 0
	jmp	SHORT $LN3@golfread
$LN2@golfread:
	mov	eax, DWORD PTR _loop$23798[ebp]
	add	eax, 1
	mov	DWORD PTR _loop$23798[ebp], eax
$LN3@golfread:
	mov	eax, DWORD PTR _loop$23798[ebp]
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T31121[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T31122[ebp], edx
	lea	eax, DWORD PTR $T31121[ebp]
	push	eax
	lea	ecx, DWORD PTR $T31122[ebp]
	push	ecx
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T31123[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T31124[ebp], edx
	lea	eax, DWORD PTR $T31123[ebp]
	push	eax
	lea	ecx, DWORD PTR $T31124[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 807  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T31125[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T31125[ebp]
