; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	D:\Tools\Dev\Workspace\VS2010\Projects\cpprimer\cpprimer\golfrun.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0L@OFINODMH@Handicap?3?5?$AA@		; `string'
PUBLIC	__$ArrayPad$
PUBLIC	_main
...
EXTRN	?setgolf@@YAHAAUgolf@@@Z:PROC			; setgolf
...
; File d:\tools\dev\workspace\vs2010\projects\cpprimer\cpprimer\golfrun.cpp
CONST	SEGMENT
??_C@_0M@FKEFADNL@Full?5Name?3?5?$AA@ DB 'Full Name: ', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@OFINODMH@Handicap?3?5?$AA@
CONST	SEGMENT
??_C@_0L@OFINODMH@Handicap?3?5?$AA@ DB 'Handicap: ', 00H ; `string'
CONST	ENDS
;	COMDAT rtc$TMZ
rtc$TMZ	SEGMENT
...
; 16   : 	
; 17   : 	while (x < gs && setgolf(ag[x]))

	cmp	DWORD PTR _x$[ebp], 3
	jge	SHORT $LN2@main
	mov	eax, DWORD PTR _x$[ebp]
	imul	eax, 44					; 0000002cH
	lea	ecx, DWORD PTR _ag$[ebp+eax]
	push	ecx
	call	?setgolf@@YAHAAUgolf@@@Z		; setgolf
	add	esp, 4
	test	eax, eax
	je	SHORT $LN2@main
...
; 21   : 		cout << "Full Name: " << ag[x].fullname << endl
; 22   : 			 << "Handicap: " << ag[x].handicap << endl;
	...
	mov	edi, esp
	mov	edx, DWORD PTR _ag$[ebp+ecx+40]
	push	edx
	push	OFFSET ??_C@_0L@OFINODMH@Handicap?3?5?$AA@
	mov	ebx, esp
	mov	eax, DWORD PTR __imp_?endl@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@1@AAV21@@Z
	push	eax
	mov	ecx, DWORD PTR _x$[ebp]
	imul	ecx, 44					; 0000002cH
	lea	edx, DWORD PTR _ag$[ebp+ecx]
	push	edx
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30388[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T30389[ebp], edx
	lea	eax, DWORD PTR $T30388[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30389[ebp]
	push	ecx
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30390[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T30391[ebp], edx
	lea	eax, DWORD PTR $T30390[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30391[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 807  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T30392[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T30392[ebp]
