; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	D:\Tools\Dev\Workspace\VS2010\Projects\cpprimer\cpprimer\ch10ex3_golfdef.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
PUBLIC	??0golf@@QAE@PBDH@Z				; golf::golf
EXTRN	_strlen:PROC
EXTRN	__RTC_CheckEsp:PROC
EXTRN	__RTC_Shutdown:PROC
EXTRN	__RTC_InitBase:PROC
;	COMDAT rtc$TMZ
; File d:\tools\dev\workspace\vs2010\projects\cpprimer\cpprimer\ch10ex3_golfdef.cpp
rtc$TMZ	SEGMENT
...
_name$ = 8						; size = 4
_hc$ = 12						; size = 4
??0golf@@QAE@PBDH@Z PROC				; golf::golf, COMDAT
; _this$ = ecx
...
; 8    : 
; 9    : 	for (int x=(strlen(name)); i < x; i++)

	mov	eax, DWORD PTR _name$[ebp]
	push	eax
	call	_strlen
	add	esp, 4
	mov	DWORD PTR _x$23234[ebp], eax
	jmp	SHORT $LN3@golf
$LN2@golf:
...
$LN3@golf:
	mov	eax, DWORD PTR _i$[ebp]
	cmp	eax, DWORD PTR _x$23234[ebp]
	jge	SHORT $LN1@golf

; 10   : 		golf::g.fullname[i] = name[i]; // could also do *(name+i)
...
; 16   : }
	...
	pop	ebp
	ret	8
??0golf@@QAE@PBDH@Z ENDP				; golf::golf
_TEXT	ENDS
PUBLIC	??1golf@@QAE@XZ					; golf::~golf
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??1golf@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??1golf@@QAE@XZ PROC					; golf::~golf, COMDAT
; _this$ = ecx
...
; 21   : }
	...
	pop	ebp
	ret	0
??1golf@@QAE@XZ ENDP					; golf::~golf
_TEXT	ENDS
PUBLIC	??_C@_0BG@NPEDODDA@And?5their?5handicap?$DP?$CB?5?$AA@ ; `string'
PUBLIC	??_C@_0BH@MFCFKGAL@Terminating?5input?5loop?$AA@ ; `string'
PUBLIC	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
PUBLIC	??_C@_0BG@MIJEBCPH@Enter?5golfer?8s?5name?3?5?$AA@ ; `string'
PUBLIC	__$ArrayPad$
PUBLIC	?setgolf@golf@@QAEAAV1@XZ			; golf::setgolf
...
;	COMDAT ??_C@_0BG@NPEDODDA@And?5their?5handicap?$DP?$CB?5?$AA@
CONST	SEGMENT
??_C@_0BG@NPEDODDA@And?5their?5handicap?$DP?$CB?5?$AA@ DB 'And their hand'
	DB	'icap?! ', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@MFCFKGAL@Terminating?5input?5loop?$AA@
CONST	SEGMENT
??_C@_0BH@MFCFKGAL@Terminating?5input?5loop?$AA@ DB 'Terminating input lo'
	DB	'op', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@MIJEBCPH@Enter?5golfer?8s?5name?3?5?$AA@
CONST	SEGMENT
??_C@_0BG@MIJEBCPH@Enter?5golfer?8s?5name?3?5?$AA@ DB 'Enter golfer''s na'
	DB	'me: ', 00H					; `string'
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ?setgolf@golf@@QAEAAV1@XZ
_TEXT	SEGMENT
tv134 = -348						; size = 4
$T30494 = -340						; size = 4
$T30495 = -328						; size = 4
$T23456 = -316						; size = 44
_tempHC$ = -72						; size = 4
_tempName$ = -60					; size = 40
_this$ = -12						; size = 4
__$ArrayPad$ = -4					; size = 4
?setgolf@golf@@QAEAAV1@XZ PROC				; golf::setgolf, COMDAT
; _this$ = ecx
...
; 25   : 	char tempName[Len];
; 26   : 	int tempHC;
; 27   : 
; 28   : 	std::cout << "Enter golfer's name: ";

	push	OFFSET ??_C@_0BG@MIJEBCPH@Enter?5golfer?8s?5name?3?5?$AA@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8

; 29   : 	if (std::cin.getline(tempName, Len))
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T30494[ebp], eax
	mov	ecx, DWORD PTR $T30494[ebp]
...
; 30   : 		if (strlen(g.fullname) == 0)
	...
	add	esp, 4
	test	eax, eax
	jne	SHORT $LN2@setgolf

; 31   : 		{
; 32   : 			std::cout << "Terminating input loop" << std::endl;

	mov	esi, esp
	mov	eax, DWORD PTR __imp_?endl@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@1@AAV21@@Z
	push	eax
	push	OFFSET ??_C@_0BH@MFCFKGAL@Terminating?5input?5loop?$AA@
...
; 33   : 			return *this;
	...
	mov	eax, DWORD PTR _this$[ebp]
	jmp	SHORT $LN4@setgolf

; 34   : 		}
; 35   : 	else 

	jmp	SHORT $LN3@setgolf
$LN2@setgolf:

; 36   : 	{
; 37   : 		std::cout << "And their handicap?! ";

	push	OFFSET ??_C@_0BG@NPEDODDA@And?5their?5handicap?$DP?$CB?5?$AA@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 40   : 	}
; 41   : 
; 42   : 		return golf::golf(tempName, tempHC);

	mov	eax, DWORD PTR _tempHC$[ebp]
	push	eax
	lea	ecx, DWORD PTR _tempName$[ebp]
	push	ecx
	lea	ecx, DWORD PTR $T23456[ebp]
	call	??0golf@@QAE@PBDH@Z			; golf::golf
	mov	DWORD PTR tv134[ebp], eax
	mov	edx, DWORD PTR tv134[ebp]
	mov	DWORD PTR $T30495[ebp], edx
	lea	ecx, DWORD PTR $T23456[ebp]
	call	??1golf@@QAE@XZ				; golf::~golf
	mov	eax, DWORD PTR $T30495[ebp]
$LN4@setgolf:
...
; 45   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN10@setgolf
...
$LN7@setgolf:
	...
	DB	101					; 00000065H
	DB	0
?setgolf@golf@@QAEAAV1@XZ ENDP				; golf::setgolf
_TEXT	ENDS
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30508[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T30509[ebp], edx
	lea	eax, DWORD PTR $T30508[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30509[ebp]
	push	ecx
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30510[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T30511[ebp], edx
	lea	eax, DWORD PTR $T30510[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30511[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 807  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T30512[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T30512[ebp]
