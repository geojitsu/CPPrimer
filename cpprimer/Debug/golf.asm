; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	D:\Tools\Dev\Workspace\VS2010\Projects\cpprimer\cpprimer\golf.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
PUBLIC	?setgolf@@YAXAAUgolf@@PBDH@Z			; setgolf
EXTRN	__RTC_Shutdown:PROC
EXTRN	__RTC_InitBase:PROC
;	COMDAT rtc$TMZ
; File d:\tools\dev\workspace\vs2010\projects\cpprimer\cpprimer\golf.cpp
rtc$TMZ	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT ?setgolf@@YAXAAUgolf@@PBDH@Z
_TEXT	SEGMENT
_g$ = 8							; size = 4
_name$ = 12						; size = 4
_hc$ = 16						; size = 4
?setgolf@@YAXAAUgolf@@PBDH@Z PROC			; setgolf, COMDAT
...
; 11   : }
	...
	pop	ebp
	ret	0
?setgolf@@YAXAAUgolf@@PBDH@Z ENDP			; setgolf
_TEXT	ENDS
...
PUBLIC	?setgolf@@YAHAAUgolf@@@Z			; setgolf
...
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ?setgolf@@YAHAAUgolf@@@Z
_TEXT	SEGMENT
$T30473 = -200						; size = 4
_g$ = 8							; size = 4
?setgolf@@YAHAAUgolf@@@Z PROC				; setgolf, COMDAT
...
; 15   : 	std::cout << "Enter golfer's name: ";
...
; 16   : 	if (std::cin.getline(g.fullname, Len))
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T30473[ebp], eax
	mov	ecx, DWORD PTR $T30473[ebp]
...
; 18   : 		{
; 19   : 			std::cout << "Terminating input loop" << std::endl;
...
; 23   : 	{
; 24   : 		std::cout << "And their handicap?! ";
...
; 29   : }
	...
	pop	ebp
	ret	0
?setgolf@@YAHAAUgolf@@@Z ENDP				; setgolf
_TEXT	ENDS
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30479[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T30480[ebp], edx
	lea	eax, DWORD PTR $T30479[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30480[ebp]
	push	ecx
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30481[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T30482[ebp], edx
	lea	eax, DWORD PTR $T30481[ebp]
	push	eax
...
; 807  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T30483[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T30483[ebp]
