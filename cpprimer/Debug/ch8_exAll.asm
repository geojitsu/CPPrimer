; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	D:\Tools\Dev\Workspace\VS2010\Projects\cpprimer\cpprimer\ch8_exAll.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?xabby@?A0x4d2b50bd@@3PAHA			; `anonymous namespace'::xabby
PUBLIC	?xaddy@?A0x4d2b50bd@@3PANA			; `anonymous namespace'::xaddy
_DATA	SEGMENT
?xabby@?A0x4d2b50bd@@3PAHA DD 01H			; `anonymous namespace'::xabby
	DD	046H
	DD	0cH
	DD	034H
	DD	01f4H
	ORG $+4
?xaddy@?A0x4d2b50bd@@3PANA DQ 03ff028f5c28f5c29r ; 1.01	; `anonymous namespace'::xaddy
	DQ	0405e8147ae147ae1r		; 122.02
	DQ	0408cd83d70a3d70ar		; 923.03
	DQ	0405f028f5c28f5c3r		; 124.04
	DQ	040b3880ccccccccdr		; 5000.05
_DATA	ENDS
...
PUBLIC	?ch8_ex7@@YAXXZ					; ch8_ex7
PUBLIC	?ch8_ex6@@YAXXZ					; ch8_ex6
...
; File d:\tools\dev\workspace\vs2010\projects\cpprimer\cpprimer\ch8_exall.cpp
CONST	SEGMENT
...
; 20   : 	char count;
; 21   : 
; 22   : 	while ((cin >> count).get() && count != 'q')
...
; 24   : 		switch (count)
	...
	jmp	DWORD PTR $LN18@main[edx*4]
$LN8@main:

; 25   : 		{
; 26   : 		case '1': ch8_ex1(); break;

	call	?ch8_ex1@@YAXXZ				; ch8_ex1
	jmp	SHORT $LN9@main
$LN7@main:

; 27   : 		case '2': ch8_ex2(); break;

	call	?ch8_ex2@@YAXXZ				; ch8_ex2
	jmp	SHORT $LN9@main
$LN6@main:

; 28   : 		case '3': ch8_ex3(); break;

	call	?ch8_ex3@@YAXXZ				; ch8_ex3
	jmp	SHORT $LN9@main
$LN5@main:

; 29   : 		case '4': ch8_ex4(); break;

	call	?ch8_ex4@@YAXXZ				; ch8_ex4
	jmp	SHORT $LN9@main
$LN4@main:

; 30   : 		case '5': ch8_ex5(); break;

	call	?ch8_ex5@@YAXXZ				; ch8_ex5
	jmp	SHORT $LN9@main
$LN3@main:

; 31   : 		case '6': ch8_ex6(); break;

	call	?ch8_ex6@@YAXXZ				; ch8_ex6
	jmp	SHORT $LN9@main
$LN2@main:

; 32   : 		case '7': ch8_ex7(); break;

	call	?ch8_ex7@@YAXXZ				; ch8_ex7
	jmp	SHORT $LN9@main
$LN1@main:

; 33   : 		default: cout << "Invalid selection, try again <q to quit>: ";
...
; 46   : 	{
; 47   : 		for (int loop = 0; loop < (y+1); loop++)

	mov	DWORD PTR _loop$24690[ebp], 0
	jmp	SHORT $LN4@strings
$LN3@strings:
	mov	eax, DWORD PTR _loop$24690[ebp]
	add	eax, 1
	mov	DWORD PTR _loop$24690[ebp], eax
$LN4@strings:
	mov	eax, DWORD PTR _y$[ebp]
	mov	ecx, DWORD PTR [eax]
	add	ecx, 1
	cmp	DWORD PTR _loop$24690[ebp], ecx
...
; 60   : 	char * strCheese = "Farfignugent";
...
; 91   : 	cout << "Weight (Ounces): " << cbr.weight << endl;
...
; 96   : 	CandyBar first = {"MMMMBar", 12.7, 250};
...
; 97   : 	CandyBar two = {"Snickers", 13.9, 450};
...
; 98   : 	CandyBar three, four, five;
; 99   : 
; 100  : 	cbfill(three, first.brand, first.weight, first.cal);
...
; 102  : 
; 103  : 	cbfill(four, two.brand, two.weight, two.cal);
...
; 121  : 	for (int x = 0; x < orig.size(); x++)

	mov	DWORD PTR _x$24816[ebp], 0
	jmp	SHORT $LN3@superSizes
$LN2@superSizes:
	mov	eax, DWORD PTR _x$24816[ebp]
	add	eax, 1
	mov	DWORD PTR _x$24816[ebp], eax
$LN3@superSizes:
	mov	ecx, DWORD PTR _orig$[ebp]
	call	?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::size
	cmp	DWORD PTR _x$24816[ebp], eax
	jae	SHORT $LN4@superSizes

; 122  : 		orig[x] = toupper(orig[x]);
	...
	call	__RTC_CheckEsp
	mov	ebx, eax
	mov	edx, DWORD PTR _x$24816[ebp]
	push	edx
	mov	ecx, DWORD PTR _orig$[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	mov	BYTE PTR [eax], bl
...
; 128  : 
; 129  : 	cout << "Enter a string (q to quit): ";
...
; 130  : 	while (getline(cin, supersizeMe) && supersizeMe != "q")
	...
	add	esp, 8
	mov	DWORD PTR $T32054[ebp], eax
	mov	edx, DWORD PTR $T32054[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR $T32054[ebp]
...
; 133  : 		cout << supersizeMe << endl
; 134  : 			 << "Next string (q to quit): ";
...
; 155  : 	 
; 156  : 	bootcamp.str = new char[(strlen(chrp) - 1)];
	...
	add	esp, 4
	mov	DWORD PTR $T32072[ebp], eax
	mov	ecx, DWORD PTR _bootcamp$[ebp]
	mov	edx, DWORD PTR $T32072[ebp]
...
; 167  : 	for (int booty = 0; booty < xxx; booty++)

	mov	DWORD PTR _booty$24943[ebp], 0
	jmp	SHORT $LN3@show
$LN2@show:
	mov	eax, DWORD PTR _booty$24943[ebp]
	add	eax, 1
	mov	DWORD PTR _booty$24943[ebp], eax
$LN3@show:
	mov	eax, DWORD PTR _booty$24943[ebp]
	cmp	eax, DWORD PTR _xxx$[ebp]
	jge	SHORT $LN4@show

; 168  : 		cout << butterball.str << endl;
...
; 174  : 	for (int booty = 0; booty < yyy; booty++)

	mov	DWORD PTR _booty$24959[ebp], 0
	jmp	SHORT $LN3@show@2
$LN2@show@2:
	mov	eax, DWORD PTR _booty$24959[ebp]
	add	eax, 1
	mov	DWORD PTR _booty$24959[ebp], eax
$LN3@show@2:
	mov	eax, DWORD PTR _booty$24959[ebp]
	cmp	eax, DWORD PTR _yyy$[ebp]
	jge	SHORT $LN4@show@2

; 175  : 		cout << gutter << endl;
...
; 181  : 
; 182  : 	stringy beany;
; 183  : 	char testing[] = "Reality isn't what it used to be.";
...
_TEXT	ENDS
PUBLIC	??$max5@N@@YANQAN@Z				; max5<double>
PUBLIC	??$max5@H@@YAHQAH@Z				; max5<int>
; Function compile flags: /Odtp /RTCsu /ZI
...
; 235  : 	double dlarge;
; 236  : 
; 237  : 	ilarge = max5(xabby);

	push	OFFSET ?xabby@?A0x4d2b50bd@@3PAHA	; `anonymous namespace'::xabby
	call	??$max5@H@@YAHQAH@Z			; max5<int>
	add	esp, 4
	mov	DWORD PTR _ilarge$[ebp], eax

; 238  : 	cout << ilarge << endl; 

	mov	esi, esp
	mov	eax, DWORD PTR __imp_?endl@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@1@AAV21@@Z
	push	eax
	mov	edi, esp
	mov	ecx, DWORD PTR _ilarge$[ebp]
	push	ecx
...
; 239  : 	dlarge = max5(xaddy);

	push	OFFSET ?xaddy@?A0x4d2b50bd@@3PANA	; `anonymous namespace'::xaddy
	call	??$max5@N@@YANQAN@Z			; max5<double>
	add	esp, 4
	fstp	QWORD PTR _dlarge$[ebp]

; 240  : 	cout << dlarge << endl;
...
_TEXT	ENDS
PUBLIC	??$maxn@PAD@@YAPADQAPADH@Z			; maxn<char *>
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??$maxn@PAD@@YAPADQAPADH@Z
_TEXT	SEGMENT
tv75 = -220						; size = 4
_x$25016 = -20						; size = 4
_sBig$ = -8						; size = 4
_arr$ = 8						; size = 4
_n$ = 12						; size = 4
??$maxn@PAD@@YAPADQAPADH@Z PROC				; maxn<char *>, COMDAT
...
; 256  : 	char * sBig = arr[0];
	...
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _sBig$[ebp], ecx

; 257  : 
; 258  : 	for (int x = 0; x < n; x++)

	mov	DWORD PTR _x$25016[ebp], 0
	jmp	SHORT $LN3@maxn
$LN2@maxn:
	mov	eax, DWORD PTR _x$25016[ebp]
	add	eax, 1
	mov	DWORD PTR _x$25016[ebp], eax
$LN3@maxn:
	mov	eax, DWORD PTR _x$25016[ebp]
	cmp	eax, DWORD PTR _n$[ebp]
	jge	SHORT $LN1@maxn

; 259  : 		sBig = (strlen(*(arr+x)) >= strlen(sBig)) ? *(arr+x) : sBig;
	...
	add	esp, 4
	mov	esi, eax
	mov	eax, DWORD PTR _sBig$[ebp]
	push	eax
	call	_strlen
	add	esp, 4
	cmp	esi, eax
	jb	SHORT $LN6@maxn
	mov	ecx, DWORD PTR _x$25016[ebp]
	mov	edx, DWORD PTR _arr$[ebp]
	mov	eax, DWORD PTR [edx+ecx*4]
	mov	DWORD PTR tv75[ebp], eax
	jmp	SHORT $LN7@maxn
$LN6@maxn:
	mov	ecx, DWORD PTR _sBig$[ebp]
	mov	DWORD PTR tv75[ebp], ecx
$LN7@maxn:
	mov	edx, DWORD PTR tv75[ebp]
	mov	DWORD PTR _sBig$[ebp], edx
	jmp	SHORT $LN2@maxn
$LN1@maxn:
...
; 262  : }
	...
	pop	ebp
	ret	0
??$maxn@PAD@@YAPADQAPADH@Z ENDP				; maxn<char *>
_TEXT	ENDS
PUBLIC	??$maxn@N@@YANPANH@Z				; maxn<double>
PUBLIC	??_C@_0CA@LMCFOGDL@And?5in?5the?5darkness?5?$CIcast?$CJ?5them?$AA@ ; `string'
PUBLIC	??_C@_0BP@FPDLIJMF@One?5double?5to?5bring?5them?5all?3?5?$AA@ ; `string'
PUBLIC	??$maxn@H@@YAHPAHH@Z				; maxn<int>
PUBLIC	??_C@_0BH@COPKOGPM@One?5int?5to?5find?5them?3?5?$AA@ ; `string'
PUBLIC	??_C@_0BO@PHGDGGLL@One?5string?5to?5rule?5them?5all?3?5?$AA@ ; `string'
PUBLIC	??_C@_08BALPDIKA@cowfrest?$AA@			; `string'
PUBLIC	??_C@_05EBJGJMAL@brown?$AA@			; `string'
PUBLIC	??_C@_0N@EMJDMHPH@nowethboweth?$AA@		; `string'
PUBLIC	??_C@_03DNMJMCD@how?$AA@			; `string'
;	COMDAT ??_C@_0CA@LMCFOGDL@And?5in?5the?5darkness?5?$CIcast?$CJ?5them?$AA@
CONST	SEGMENT
??_C@_0CA@LMCFOGDL@And?5in?5the?5darkness?5?$CIcast?$CJ?5them?$AA@ DB 'An'
	DB	'd in the darkness (cast) them', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0BP@FPDLIJMF@One?5double?5to?5bring?5them?5all?3?5?$AA@
CONST	SEGMENT
??_C@_0BP@FPDLIJMF@One?5double?5to?5bring?5them?5all?3?5?$AA@ DB 'One dou'
	DB	'ble to bring them all: ', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@COPKOGPM@One?5int?5to?5find?5them?3?5?$AA@
CONST	SEGMENT
??_C@_0BH@COPKOGPM@One?5int?5to?5find?5them?3?5?$AA@ DB 'One int to find '
	DB	'them: ', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BO@PHGDGGLL@One?5string?5to?5rule?5them?5all?3?5?$AA@
CONST	SEGMENT
??_C@_0BO@PHGDGGLL@One?5string?5to?5rule?5them?5all?3?5?$AA@ DB 'One stri'
	DB	'ng to rule them all: ', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_08BALPDIKA@cowfrest?$AA@
CONST	SEGMENT
??_C@_08BALPDIKA@cowfrest?$AA@ DB 'cowfrest', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_05EBJGJMAL@brown?$AA@
CONST	SEGMENT
??_C@_05EBJGJMAL@brown?$AA@ DB 'brown', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@EMJDMHPH@nowethboweth?$AA@
CONST	SEGMENT
??_C@_0N@EMJDMHPH@nowethboweth?$AA@ DB 'nowethboweth', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_03DNMJMCD@how?$AA@
CONST	SEGMENT
??_C@_03DNMJMCD@how?$AA@ DB 'how', 00H			; `string'
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ?ch8_ex6@@YAXXZ
_TEXT	SEGMENT
_sLargerThan$ = -32					; size = 4
_textoids$ = -20					; size = 16
?ch8_ex6@@YAXXZ PROC					; ch8_ex6, COMDAT
...
; 289  : 	char * textoids[TELLY-1] = { "how", "nowethboweth", "brown", "cowfrest" };

	mov	DWORD PTR _textoids$[ebp], OFFSET ??_C@_03DNMJMCD@how?$AA@
	mov	DWORD PTR _textoids$[ebp+4], OFFSET ??_C@_0N@EMJDMHPH@nowethboweth?$AA@
	mov	DWORD PTR _textoids$[ebp+8], OFFSET ??_C@_05EBJGJMAL@brown?$AA@
	mov	DWORD PTR _textoids$[ebp+12], OFFSET ??_C@_08BALPDIKA@cowfrest?$AA@

; 290  : 	char * sLargerThan = maxn(textoids, 4);

	push	4
	lea	eax, DWORD PTR _textoids$[ebp]
	push	eax
	call	??$maxn@PAD@@YAPADQAPADH@Z		; maxn<char *>
	add	esp, 8
	mov	DWORD PTR _sLargerThan$[ebp], eax

; 291  : 	
; 292  : 	cout << "One string to rule them all: " << maxn(textoids, 4) << endl;

	mov	esi, esp
	mov	eax, DWORD PTR __imp_?endl@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@1@AAV21@@Z
	push	eax
	push	4
	lea	ecx, DWORD PTR _textoids$[ebp]
	push	ecx
	call	??$maxn@PAD@@YAPADQAPADH@Z		; maxn<char *>
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BO@PHGDGGLL@One?5string?5to?5rule?5them?5all?3?5?$AA@
	mov	edx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	edx
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 293  : 	cout << "One int to find them: ";

	push	OFFSET ??_C@_0BH@COPKOGPM@One?5int?5to?5find?5them?3?5?$AA@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8

; 294  : 	cout << maxn(xabby, TELLY) << endl;
	...
	push	5
	push	OFFSET ?xabby@?A0x4d2b50bd@@3PAHA	; `anonymous namespace'::xabby
	call	??$maxn@H@@YAHPAHH@Z			; maxn<int>
	add	esp, 8
	mov	edi, esp
	push	eax
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
...
; 295  : 	cout << "One double to bring them all: ";

	push	OFFSET ??_C@_0BP@FPDLIJMF@One?5double?5to?5bring?5them?5all?3?5?$AA@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8

; 296  : 	cout << maxn(xaddy, TELLY) << endl << "And in the darkness (cast) them";

	push	OFFSET ??_C@_0CA@LMCFOGDL@And?5in?5the?5darkness?5?$CIcast?$CJ?5them?$AA@
	mov	esi, esp
	mov	eax, DWORD PTR __imp_?endl@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@1@AAV21@@Z
	push	eax
	push	5
	push	OFFSET ?xaddy@?A0x4d2b50bd@@3PANA	; `anonymous namespace'::xaddy
	call	??$maxn@N@@YANPANH@Z			; maxn<double>
	add	esp, 8
	mov	edi, esp
	sub	esp, 8
	fstp	QWORD PTR [esp]
...
$LN3@ch8_ex6:
	...
	DB	115					; 00000073H
	DB	0
?ch8_ex6@@YAXXZ ENDP					; ch8_ex6
_TEXT	ENDS
PUBLIC	??_C@_0CJ@CLEMDOCC@Listings?5the?5sum?5total?5of?5Mr?5E?8s@ ; `string'
PUBLIC	??$SumArray@N@@YANQAPANH@Z			; SumArray<double>
PUBLIC	??_C@_0CJ@KBCLIBJC@Listing?5the?5sum?5total?5of?5Mr?5E?8s?5@ ; `string'
PUBLIC	??$SumArray@H@@YAHQAHH@Z			; SumArray<int>
PUBLIC	__real@409c200000000000
PUBLIC	??_C@_09IMIJGMKM@Iby?5Stout?$AA@		; `string'
PUBLIC	__real@4094500000000000
PUBLIC	??_C@_08BDLFNHFE@Ura?5Foxe?$AA@			; `string'
PUBLIC	__real@40a2c00000000000
PUBLIC	??_C@_09CPMDPMLB@Ima?5Wolfe?$AA@		; `string'
PUBLIC	__$ArrayPad$
EXTRN	_memset:PROC
;	COMDAT ??_C@_0CJ@CLEMDOCC@Listings?5the?5sum?5total?5of?5Mr?5E?8s@
CONST	SEGMENT
??_C@_0CJ@CLEMDOCC@Listings?5the?5sum?5total?5of?5Mr?5E?8s@ DB 'Listings '
	DB	'the sum total of Mr E''s Debts: ', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0CJ@KBCLIBJC@Listing?5the?5sum?5total?5of?5Mr?5E?8s?5@
CONST	SEGMENT
??_C@_0CJ@KBCLIBJC@Listing?5the?5sum?5total?5of?5Mr?5E?8s?5@ DB 'Listing '
	DB	'the sum total of Mr E''s things: ', 00H	; `string'
CONST	ENDS
;	COMDAT __real@409c200000000000
CONST	SEGMENT
__real@409c200000000000 DQ 0409c200000000000r	; 1800
CONST	ENDS
;	COMDAT ??_C@_09IMIJGMKM@Iby?5Stout?$AA@
CONST	SEGMENT
??_C@_09IMIJGMKM@Iby?5Stout?$AA@ DB 'Iby Stout', 00H	; `string'
CONST	ENDS
;	COMDAT __real@4094500000000000
CONST	SEGMENT
__real@4094500000000000 DQ 04094500000000000r	; 1300
CONST	ENDS
;	COMDAT ??_C@_08BDLFNHFE@Ura?5Foxe?$AA@
CONST	SEGMENT
??_C@_08BDLFNHFE@Ura?5Foxe?$AA@ DB 'Ura Foxe', 00H	; `string'
CONST	ENDS
;	COMDAT __real@40a2c00000000000
CONST	SEGMENT
__real@40a2c00000000000 DQ 040a2c00000000000r	; 2400
CONST	ENDS
;	COMDAT ??_C@_09CPMDPMLB@Ima?5Wolfe?$AA@
CONST	SEGMENT
??_C@_09CPMDPMLB@Ima?5Wolfe?$AA@ DB 'Ima Wolfe', 00H	; `string'
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ?ch8_ex7@@YAXXZ
_TEXT	SEGMENT
_i$25085 = -292						; size = 4
_pd$ = -280						; size = 12
_mr_E$ = -260						; size = 192
...
_things$ = -32						; size = 24
__$ArrayPad$ = -4					; size = 4
?ch8_ex7@@YAXXZ PROC					; ch8_ex7, COMDAT
...
; 320  : 	int things[6] = {13, 31, 103, 301, 310, 130};

	mov	DWORD PTR _things$[ebp], 13		; 0000000dH
	mov	DWORD PTR _things$[ebp+4], 31		; 0000001fH
	mov	DWORD PTR _things$[ebp+8], 103		; 00000067H
	mov	DWORD PTR _things$[ebp+12], 301		; 0000012dH
	mov	DWORD PTR _things$[ebp+16], 310		; 00000136H
	mov	DWORD PTR _things$[ebp+20], 130		; 00000082H
...
; 324  : 	debts mr_E[3] =
; 325  : 	{
; 326  : 		{"Ima Wolfe", 2400.0},

	mov	eax, DWORD PTR ??_C@_09CPMDPMLB@Ima?5Wolfe?$AA@
	mov	DWORD PTR _mr_E$[ebp], eax
	mov	ecx, DWORD PTR ??_C@_09CPMDPMLB@Ima?5Wolfe?$AA@+4
	mov	DWORD PTR _mr_E$[ebp+4], ecx
	mov	dx, WORD PTR ??_C@_09CPMDPMLB@Ima?5Wolfe?$AA@+8
	mov	WORD PTR _mr_E$[ebp+8], dx
	xor	eax, eax
	mov	DWORD PTR _mr_E$[ebp+10], eax
	mov	DWORD PTR _mr_E$[ebp+14], eax
	mov	DWORD PTR _mr_E$[ebp+18], eax
	mov	DWORD PTR _mr_E$[ebp+22], eax
	mov	DWORD PTR _mr_E$[ebp+26], eax
	mov	DWORD PTR _mr_E$[ebp+30], eax
	mov	DWORD PTR _mr_E$[ebp+34], eax
	mov	DWORD PTR _mr_E$[ebp+38], eax
	mov	DWORD PTR _mr_E$[ebp+42], eax
	mov	DWORD PTR _mr_E$[ebp+46], eax
	fld	QWORD PTR __real@40a2c00000000000
	fstp	QWORD PTR _mr_E$[ebp+56]

; 327  : 		{"Ura Foxe", 1300.0},

	mov	eax, DWORD PTR ??_C@_08BDLFNHFE@Ura?5Foxe?$AA@
	mov	DWORD PTR _mr_E$[ebp+64], eax
	mov	ecx, DWORD PTR ??_C@_08BDLFNHFE@Ura?5Foxe?$AA@+4
	mov	DWORD PTR _mr_E$[ebp+68], ecx
	mov	dl, BYTE PTR ??_C@_08BDLFNHFE@Ura?5Foxe?$AA@+8
	mov	BYTE PTR _mr_E$[ebp+72], dl
	push	41					; 00000029H
	push	0
	lea	eax, DWORD PTR _mr_E$[ebp+73]
	push	eax
	call	_memset
	add	esp, 12					; 0000000cH
	fld	QWORD PTR __real@4094500000000000
	fstp	QWORD PTR _mr_E$[ebp+120]

; 328  : 		{"Iby Stout", 1800.0},

	mov	eax, DWORD PTR ??_C@_09IMIJGMKM@Iby?5Stout?$AA@
	mov	DWORD PTR _mr_E$[ebp+128], eax
	mov	ecx, DWORD PTR ??_C@_09IMIJGMKM@Iby?5Stout?$AA@+4
	mov	DWORD PTR _mr_E$[ebp+132], ecx
	mov	dx, WORD PTR ??_C@_09IMIJGMKM@Iby?5Stout?$AA@+8
	mov	WORD PTR _mr_E$[ebp+136], dx
	xor	eax, eax
	mov	DWORD PTR _mr_E$[ebp+138], eax
	mov	DWORD PTR _mr_E$[ebp+142], eax
	mov	DWORD PTR _mr_E$[ebp+146], eax
	mov	DWORD PTR _mr_E$[ebp+150], eax
	mov	DWORD PTR _mr_E$[ebp+154], eax
	mov	DWORD PTR _mr_E$[ebp+158], eax
	mov	DWORD PTR _mr_E$[ebp+162], eax
	mov	DWORD PTR _mr_E$[ebp+166], eax
	mov	DWORD PTR _mr_E$[ebp+170], eax
	mov	DWORD PTR _mr_E$[ebp+174], eax
	fld	QWORD PTR __real@409c200000000000
	fstp	QWORD PTR _mr_E$[ebp+184]
...
; 333  : 	for (int i = 0; i < 3; i++)
	...
	mov	DWORD PTR _i$25085[ebp], 0
	jmp	SHORT $LN3@ch8_ex7
$LN2@ch8_ex7:
	mov	eax, DWORD PTR _i$25085[ebp]
	add	eax, 1
	mov	DWORD PTR _i$25085[ebp], eax
$LN3@ch8_ex7:
	cmp	DWORD PTR _i$25085[ebp], 3
	jge	SHORT $LN1@ch8_ex7

; 334  : 		pd[i] = &mr_E[i].amount;

	mov	eax, DWORD PTR _i$25085[ebp]
	shl	eax, 6
	lea	ecx, DWORD PTR _mr_E$[ebp+eax+56]
	mov	edx, DWORD PTR _i$25085[ebp]
	mov	DWORD PTR _pd$[ebp+edx*4], ecx
	jmp	SHORT $LN2@ch8_ex7
$LN1@ch8_ex7:

; 335  : 
; 336  : 
; 337  : 	isum = SumArray(things, 6);

	push	6
	lea	eax, DWORD PTR _things$[ebp]
	push	eax
	call	??$SumArray@H@@YAHQAHH@Z		; SumArray<int>
	add	esp, 8
	mov	DWORD PTR _isum$[ebp], eax

; 338  : 	cout << "Listing the sum total of Mr E's things: " << isum << endl;
	...
	push	ecx
	push	OFFSET ??_C@_0CJ@KBCLIBJC@Listing?5the?5sum?5total?5of?5Mr?5E?8s?5@
	mov	edx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	edx
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 339  : 	dsum = SumArray(pd, 3);

	push	3
	lea	eax, DWORD PTR _pd$[ebp]
	push	eax
	call	??$SumArray@N@@YANQAPANH@Z		; SumArray<double>
	add	esp, 8
	fstp	QWORD PTR _dsum$[ebp]

; 340  : 	cout << "Listings the sum total of Mr E's Debts: " << dsum << endl;
	...
	mov	edi, esp
	sub	esp, 8
	fld	QWORD PTR _dsum$[ebp]
	fstp	QWORD PTR [esp]
	push	OFFSET ??_C@_0CJ@CLEMDOCC@Listings?5the?5sum?5total?5of?5Mr?5E?8s@
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 342  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN10@ch8_ex7
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	pop	edi
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	DWORD PTR __Ptr$27056[ebp], ecx
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	eax
	mov	ecx, DWORD PTR __Ptr$27056[ebp]
	push	ecx
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	ecx, 1
	push	ecx
	mov	edx, DWORD PTR __Ptr$27056[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T32174[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T32174[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T32189[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T32190[ebp], edx
	lea	eax, DWORD PTR $T32189[ebp]
	push	eax
	lea	ecx, DWORD PTR $T32190[ebp]
	push	ecx
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T32191[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T32192[ebp], edx
	lea	eax, DWORD PTR $T32191[ebp]
	push	eax
	lea	ecx, DWORD PTR $T32192[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 807  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T32193[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T32193[ebp]
...
; 511  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T32254[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv289[ebp], eax
	mov	edx, DWORD PTR tv289[ebp]
	mov	DWORD PTR $T32255[ebp], edx
	lea	eax, DWORD PTR $T32254[ebp]
	push	eax
	lea	ecx, DWORD PTR $T32255[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 523  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T32256[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv297[ebp], eax
	mov	edx, DWORD PTR tv297[ebp]
	mov	DWORD PTR $T32257[ebp], edx
	lea	eax, DWORD PTR $T32256[ebp]
	push	eax
	lea	ecx, DWORD PTR $T32257[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 533  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T32258[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T32258[ebp]
...
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ??$max5@H@@YAHQAH@Z
_TEXT	SEGMENT
tv71 = -220						; size = 4
_x$29392 = -20						; size = 4
_theLargeOne$ = -8					; size = 4
_qqq$ = 8						; size = 4
??$max5@H@@YAHQAH@Z PROC				; max5<int>, COMDAT
...
; 215  : 	T theLargeOne = 0;
	...
	mov	DWORD PTR _theLargeOne$[ebp], 0

; 216  : 
; 217  : 	for (int x = 0; x < ::TELLY; x++)

	mov	DWORD PTR _x$29392[ebp], 0
	jmp	SHORT $LN6@max5
$LN5@max5:
	mov	eax, DWORD PTR _x$29392[ebp]
	add	eax, 1
	mov	DWORD PTR _x$29392[ebp], eax
$LN6@max5:
	cmp	DWORD PTR _x$29392[ebp], 5
	jge	$LN4@max5

; 218  : 	{
; 219  : 		theLargeOne = ((qqq[x] >= theLargeOne) ? qqq[x] : theLargeOne);

	mov	eax, DWORD PTR _x$29392[ebp]
	mov	ecx, DWORD PTR _qqq$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4]
	cmp	edx, DWORD PTR _theLargeOne$[ebp]
	jl	SHORT $LN9@max5
	mov	eax, DWORD PTR _x$29392[ebp]
	mov	ecx, DWORD PTR _qqq$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4]
	...
	jmp	SHORT $LN10@max5
$LN9@max5:
	mov	eax, DWORD PTR _theLargeOne$[ebp]
	mov	DWORD PTR tv71[ebp], eax
$LN10@max5:
	mov	ecx, DWORD PTR tv71[ebp]
	mov	DWORD PTR _theLargeOne$[ebp], ecx

; 220  : 
; 221  : 		if (x == ::TELLY-1)

	cmp	DWORD PTR _x$29392[ebp], 4
	jne	SHORT $LN3@max5
...
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ??$max5@N@@YANQAN@Z
_TEXT	SEGMENT
tv71 = -228						; size = 8
_x$29403 = -24						; size = 4
_theLargeOne$ = -12					; size = 8
_qqq$ = 8						; size = 4
??$max5@N@@YANQAN@Z PROC				; max5<double>, COMDAT
...
; 215  : 	T theLargeOne = 0;
	...
	fldz
	fstp	QWORD PTR _theLargeOne$[ebp]

; 216  : 
; 217  : 	for (int x = 0; x < ::TELLY; x++)

	mov	DWORD PTR _x$29403[ebp], 0
	jmp	SHORT $LN6@max5@2
$LN5@max5@2:
	mov	eax, DWORD PTR _x$29403[ebp]
	add	eax, 1
	mov	DWORD PTR _x$29403[ebp], eax
$LN6@max5@2:
	cmp	DWORD PTR _x$29403[ebp], 5
	jge	$LN4@max5@2
...
; 219  : 		theLargeOne = ((qqq[x] >= theLargeOne) ? qqq[x] : theLargeOne);
	...
	mov	eax, DWORD PTR _x$29403[ebp]
	mov	ecx, DWORD PTR _qqq$[ebp]
	fld	QWORD PTR _theLargeOne$[ebp]
	fcomp	QWORD PTR [ecx+eax*8]
	fnstsw	ax
	test	ah, 65					; 00000041H
	jp	SHORT $LN9@max5@2
	mov	edx, DWORD PTR _x$29403[ebp]
	mov	eax, DWORD PTR _qqq$[ebp]
	fld	QWORD PTR [eax+edx*8]
	fstp	QWORD PTR tv71[ebp]
	jmp	SHORT $LN10@max5@2
$LN9@max5@2:
	fld	QWORD PTR _theLargeOne$[ebp]
	fstp	QWORD PTR tv71[ebp]
$LN10@max5@2:
...
; 221  : 		if (x == ::TELLY-1)
	...
	cmp	DWORD PTR _x$29403[ebp], 4
	jne	SHORT $LN3@max5@2
...
; 231  : }
	...
	pop	ebp
	ret	0
??$max5@N@@YANQAN@Z ENDP				; max5<double>
; Function compile flags: /Odtp /RTCsu /ZI
_TEXT	ENDS
;	COMDAT ??$maxn@H@@YAHPAHH@Z
_TEXT	SEGMENT
tv71 = -220						; size = 4
_x$29412 = -20						; size = 4
_theLargeOne$ = -8					; size = 4
_arr$ = 8						; size = 4
_n$ = 12						; size = 4
??$maxn@H@@YAHPAHH@Z PROC				; maxn<int>, COMDAT
...
; 268  : 
; 269  : 	for (int x = 0; x < n; x++)

	mov	DWORD PTR _x$29412[ebp], 0
	jmp	SHORT $LN6@maxn@2
$LN5@maxn@2:
	mov	eax, DWORD PTR _x$29412[ebp]
	add	eax, 1
	mov	DWORD PTR _x$29412[ebp], eax
$LN6@maxn@2:
	mov	eax, DWORD PTR _x$29412[ebp]
	cmp	eax, DWORD PTR _n$[ebp]
	jge	$LN4@maxn@2
...
; 270  : 	{
; 271  : 		theLargeOne = ((arr[x] >= theLargeOne) ? arr[x] : theLargeOne);
...
; 273  : 		if (x == n-1)
	...
	sub	eax, 1
	cmp	DWORD PTR _x$29412[ebp], eax
	jne	SHORT $LN3@maxn@2
...
; 284  : }
	...
	pop	ebp
	ret	0
??$maxn@H@@YAHPAHH@Z ENDP				; maxn<int>
; Function compile flags: /Odtp /RTCsu /ZI
_TEXT	ENDS
;	COMDAT ??$maxn@N@@YANPANH@Z
_TEXT	SEGMENT
tv71 = -228						; size = 8
_x$29421 = -24						; size = 4
_theLargeOne$ = -12					; size = 8
_arr$ = 8						; size = 4
_n$ = 12						; size = 4
??$maxn@N@@YANPANH@Z PROC				; maxn<double>, COMDAT
...
; 269  : 	for (int x = 0; x < n; x++)
	...
	mov	DWORD PTR _x$29421[ebp], 0
	jmp	SHORT $LN6@maxn@3
$LN5@maxn@3:
	mov	eax, DWORD PTR _x$29421[ebp]
	add	eax, 1
	mov	DWORD PTR _x$29421[ebp], eax
$LN6@maxn@3:
	mov	eax, DWORD PTR _x$29421[ebp]
	cmp	eax, DWORD PTR _n$[ebp]
	jge	$LN4@maxn@3
...
; 271  : 		theLargeOne = ((arr[x] >= theLargeOne) ? arr[x] : theLargeOne);
	...
	test	ah, 65					; 00000041H
	jp	SHORT $LN9@maxn@3
	mov	edx, DWORD PTR _x$29421[ebp]
	mov	eax, DWORD PTR _arr$[ebp]
	fld	QWORD PTR [eax+edx*8]
	fstp	QWORD PTR tv71[ebp]
	jmp	SHORT $LN10@maxn@3
$LN9@maxn@3:
	fld	QWORD PTR _theLargeOne$[ebp]
	fstp	QWORD PTR tv71[ebp]
$LN10@maxn@3:
...
; 273  : 		if (x == n-1)
	...
	mov	eax, DWORD PTR _n$[ebp]
	sub	eax, 1
	cmp	DWORD PTR _x$29421[ebp], eax
	jne	SHORT $LN3@maxn@3
...
; 284  : }
	...
	pop	ebp
	ret	0
??$maxn@N@@YANPANH@Z ENDP				; maxn<double>
_TEXT	ENDS
PUBLIC	??_C@_0M@BGDOBAHI@template?5A?6?$AA@		; `string'
;	COMDAT ??_C@_0M@BGDOBAHI@template?5A?6?$AA@
CONST	SEGMENT
??_C@_0M@BGDOBAHI@template?5A?6?$AA@ DB 'template A', 0aH, 00H ; `string'
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ??$SumArray@H@@YAHQAHH@Z
_TEXT	SEGMENT
_i$29431 = -20						; size = 4
_sumTotal$ = -8						; size = 4
_arr$ = 8						; size = 4
_n$ = 12						; size = 4
??$SumArray@H@@YAHQAHH@Z PROC				; SumArray<int>, COMDAT
...
; 347  : 	T sumTotal = 0;
	...
	mov	DWORD PTR _sumTotal$[ebp], 0

; 348  : 
; 349  : 	cout << "template A\n";

	push	OFFSET ??_C@_0M@BGDOBAHI@template?5A?6?$AA@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 350  : 	for (int i = 0; i < n; i++)
	...
	mov	DWORD PTR _i$29431[ebp], 0
	jmp	SHORT $LN3@SumArray
$LN2@SumArray:
	mov	eax, DWORD PTR _i$29431[ebp]
	add	eax, 1
	mov	DWORD PTR _i$29431[ebp], eax
$LN3@SumArray:
	mov	eax, DWORD PTR _i$29431[ebp]
	cmp	eax, DWORD PTR _n$[ebp]
	jge	SHORT $LN1@SumArray

; 351  : 		sumTotal += arr[i];

	mov	eax, DWORD PTR _i$29431[ebp]
	mov	ecx, DWORD PTR _arr$[ebp]
	mov	edx, DWORD PTR _sumTotal$[ebp]
	add	edx, DWORD PTR [ecx+eax*4]
	mov	DWORD PTR _sumTotal$[ebp], edx
	jmp	SHORT $LN2@SumArray
$LN1@SumArray:

; 352  : 
; 353  : 	return sumTotal;

	mov	eax, DWORD PTR _sumTotal$[ebp]
...
; 354  : }
	...
	pop	ebp
	ret	0
??$SumArray@H@@YAHQAHH@Z ENDP				; SumArray<int>
_TEXT	ENDS
PUBLIC	??_C@_0M@BEHIKOCB@template?5B?6?$AA@		; `string'
;	COMDAT ??_C@_0M@BEHIKOCB@template?5B?6?$AA@
CONST	SEGMENT
??_C@_0M@BEHIKOCB@template?5B?6?$AA@ DB 'template B', 0aH, 00H ; `string'
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ??$SumArray@N@@YANQAPANH@Z
_TEXT	SEGMENT
_i$29438 = -24						; size = 4
_sumTotal$ = -12					; size = 8
_arr$ = 8						; size = 4
_n$ = 12						; size = 4
??$SumArray@N@@YANQAPANH@Z PROC				; SumArray<double>, COMDAT
...
; 359  : 	T sumTotal = 0;
	...
	fldz
	fstp	QWORD PTR _sumTotal$[ebp]

; 360  : 
; 361  : 	cout << "template B\n";

	push	OFFSET ??_C@_0M@BEHIKOCB@template?5B?6?$AA@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 362  : 	for (int i = 0; i < n; i++)
	...
	mov	DWORD PTR _i$29438[ebp], 0
	jmp	SHORT $LN3@SumArray@2
$LN2@SumArray@2:
	mov	eax, DWORD PTR _i$29438[ebp]
	add	eax, 1
	mov	DWORD PTR _i$29438[ebp], eax
$LN3@SumArray@2:
	mov	eax, DWORD PTR _i$29438[ebp]
	cmp	eax, DWORD PTR _n$[ebp]
	jge	SHORT $LN1@SumArray@2
...
; 363  : 		sumTotal += *(*(arr+i));
	...
	mov	ecx, DWORD PTR _arr$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4]
	fld	QWORD PTR _sumTotal$[ebp]
	fadd	QWORD PTR [edx]
	fstp	QWORD PTR _sumTotal$[ebp]
	jmp	SHORT $LN2@SumArray@2
$LN1@SumArray@2:
...
; 366  : }
	...
	pop	ebp
	ret	0
??$SumArray@N@@YANQAPANH@Z ENDP				; SumArray<double>
; Function compile flags: /Odtp /RTCsu /ZI
; File d:\tools\dev\vs2010\vc\include\xmemory
_TEXT	ENDS
...
; 37   : 		_THROW_NCEE(bad_alloc, 0);
	...
	push	0
	lea	ecx, DWORD PTR $T32314[ebp]
	call	??0bad_alloc@std@@QAE@PBD@Z		; std::bad_alloc::bad_alloc
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	eax, DWORD PTR $T32314[ebp]
	push	eax
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T32328[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T32328[ebp], 0
	...
	mov	ecx, DWORD PTR $T32328[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T32328[ebp]
...
; 1041 : 		if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	mov	DWORD PTR $T32348[ebp], eax
	lea	ecx, DWORD PTR __Meta$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T32348[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
$T32390 = -292						; size = 4
$T32391 = -280						; size = 4
__Meta$30026 = -76					; size = 4
__Metadelim$30025 = -64					; size = 4
__Ok$ = -52						; size = 8
__Changed$ = -33					; size = 1
__State$ = -24						; size = 4
__$EHRec$ = -16						; size = 16
...
; 411  : 			_Traits::to_int_type(_Delim);
	...
	mov	DWORD PTR tv65[ebp], eax
	mov	ecx, DWORD PTR tv65[ebp]
	mov	DWORD PTR __Metadelim$30025[ebp], ecx
...
; 412  : 		typename _Traits::int_type _Meta = _Istr.rdbuf()->sgetc();
	...
	mov	DWORD PTR __Meta$30026[ebp], eax
...
; 415  : 			if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	mov	DWORD PTR $T32390[ebp], eax
	lea	ecx, DWORD PTR __Meta$30026[ebp]
	push	ecx
	lea	edx, DWORD PTR $T32390[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 420  : 			else if (_Traits::eq_int_type(_Meta, _Metadelim))
	...
	lea	eax, DWORD PTR __Metadelim$30025[ebp]
	push	eax
	lea	ecx, DWORD PTR __Meta$30026[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
...
; 433  : 				_Str += _Traits::to_char_type(_Meta);
	...
	lea	eax, DWORD PTR __Meta$30026[ebp]
	push	eax
	call	?to_char_type@?$char_traits@D@std@@SADABH@Z ; std::char_traits<char>::to_char_type
	add	esp, 4
...
; 442  : 	return (_Istr);
	...
	mov	eax, DWORD PTR __Istr$[ebp]
	mov	DWORD PTR $T32391[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_istream@DU?$char_traits@D@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR $T32391[ebp]
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	ecx, DWORD PTR [eax+20]
	sub	ecx, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Newsize$28725[ebp], ecx

; 1119 : 			_Eos(_Newsize);

	mov	eax, DWORD PTR __Newsize$28725[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 37   : 		_THROW_NCEE(bad_alloc, 0);
	...
	push	0
	lea	ecx, DWORD PTR $T32465[ebp]
	call	??0bad_alloc@std@@QAE@PBD@Z		; std::bad_alloc::bad_alloc
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	eax, DWORD PTR $T32465[ebp]
	push	eax
	call	__CxxThrowException@8
$LN3@Allocate@2:
